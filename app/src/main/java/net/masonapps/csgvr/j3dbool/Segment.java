...
public class Segment implements Cloneable {
    ...
    public Segment(Line line, Face face, int sign1, int sign2, int sign3) {
        ...
        if (sign1 == 0) {
            setVertex(face.v1);
            //other vertexArray on the same side - VERTEX-VERTEX VERTEX
            if (sign2 == sign3) {
                setVertex(face.v1);
            }
        }
    ...
    public Object clone() {
        try {
            ...
            clone.startPos = startPos.cpy();
            clone.endPos = endPos.cpy();
     ...
     *
     * @param vertex1 one of the vertexArray of the intercepted edge
     * @param vertex2 one of the vertexArray of the intercepted edge
