...
public class Object3D implements Cloneable {
     ...
     */
    private Vertex addVertex(Vector3 pos, Color color, int status) {
        int i;
                ...
                if (face1.getBound().overlap(object.getBound())) {
                    ...
                    for (int j = 0; j < object.getNumFaces(); j++) {
                        ...
                        if (face1.getBound().overlap(face2.getBound())) {
                            ...
                            //distance from the face1 vertexArray to the face2 plane
                            ...
                            //distances signs from the face1 vertexArray to the face2 plane 
                            ...
                            if (!(signFace1Vert1 == signFace1Vert2 && signFace1Vert2 == signFace1Vert3)) {
                                //distance from the face2 vertexArray to the face1 plane
                                ...
                                //distances signs from the face2 vertexArray to the face1 plane
